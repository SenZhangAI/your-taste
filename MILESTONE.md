...
- `taste insights` — batch scan of session history, working end-to-end
...
### What's validated
- `taste insights` scanned 294 sessions, analyzed 26, produced 18 structured observations (8 checkpoints, 5 domain, 5 failure patterns)
...
- `taste insights` can fail mid-scan (fetch failed at 245/294) with no graceful degradation
